...
INPUT_FILE = PROJECT_ROOT / "data" / "interim" / "library" / "spotify_enriched_library.csv"
LOG_DIR = PROJECT_ROOT / "data" / "processed" / "dq"
LOG_FILE = LOG_DIR / f"dq_spotify_enriched_library{datetime.utcnow().date().isoformat()}.csv"
